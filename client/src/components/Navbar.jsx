...
const Navbar = () => {
  ...
  return (
    <div>
      <header className="bg-primary text-primary-foreground dark:bg-gray-900 dark:text-white sticky top-0 z-50 shadow-md transition-colors duration-300">
          ...
          <div className="flex justify-between items-center">
            ...
            <nav className="hidden md:flex space-x-6 items-center">
              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent className="bg-white dark:bg-gray-800 text-black dark:text-white border dark:border-gray-700 shadow-lg">
              ...
              <button
                onClick={toggleTheme}
                className="flex items-center gap-1 hover:text-accent transition-colors p-2 rounded-lg hover:bg-white/10"
